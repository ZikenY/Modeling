...
// 将tri上的与this共享的边的adjacency转移成this的adjacency
// 在tri即将变成中间节点之前调用，确保新创建的节点有正确的adjacency
...
// make sure CCW order for (adj_v1, a, adj_v2) & (adj_v2, b, adj_v1)
// 若adj_v1在顶上，adj_v2在底下，则a在左侧，b在右侧
...
void mesh::export_obj(string filename)
{
    ...
    obj << "# Copyright by Zhiqian You." << endl;
...
int main(int args, char* argv[])
{
    ...
    cout << endl << "-------------------------------------------------------" << endl;
    cout << "TIN creator" << endl;
    cout << "Copyright by Zhiqian You." << endl;
