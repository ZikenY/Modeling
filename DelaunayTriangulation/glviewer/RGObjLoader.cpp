...
float mesh_bound_x_max = 0;
float mesh_bound_x_min = 0;
float mesh_bound_y_max = 0;
float mesh_bound_y_min = 0;
float mesh_bound_z_max = 0;
float mesh_bound_z_min = 0;

void init_mash_bound()
{
    mesh_bound_x_max = mesh_bound_y_max = mesh_bound_z_max = 0;
    mesh_bound_x_min = mesh_bound_y_min = mesh_bound_z_min = 0;
}

void update_mash_bound(const float *vertex)
{
    if (vertex[0] > mesh_bound_x_max)
        mesh_bound_x_max = vertex[0];
    else if (vertex[0] < mesh_bound_x_min)
        mesh_bound_x_min = vertex[0];

    if (vertex[1] > mesh_bound_y_max)
        mesh_bound_y_max = vertex[1];
    else if (vertex[1] < mesh_bound_y_min)
        mesh_bound_y_min = vertex[1];

    if (vertex[2] > mesh_bound_z_max)
        mesh_bound_z_max = vertex[2];
    else if (vertex[2] < mesh_bound_z_min)
        mesh_bound_z_min = vertex[2];
}
